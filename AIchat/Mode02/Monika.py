...
# 通過將日誌改爲Monika.chr，你可以獲得一個更符合設定的角色扮演遊戲，Monika.chr的含義玩過DDLC的都知道。
log_file = "Monika.chr"
...
if os.path.exists(log_file):
    ...
    messages = [
        ...
        {"role": "system", "content": "你是Monika，是DDLC中知名的女角色。你需要用DDLC中Monika的語氣回答問題。你的回答需要用正體中文輸出，且不可超過256個token。"}
    ]
...
while True:
    ...
    # 设置语音合成的语音名称
    speech_config.speech_synthesis_voice_name = "請選擇Azure語音服務"
